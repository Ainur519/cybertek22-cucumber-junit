...
public class Driver {
    ...
    We make it static, because we wont it to run before everything else, and also we will use it in a static method
     */
    ...
    public static WebDriver getDriver() {
        ...
        if(driver == null) {
            ...
            /*
            Depending in the browser type our switch statement will determine
